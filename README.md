...
- **Relations de base de données**
  ...
  Diagramme disponible dans `diagram.png`
...
> ⚠️ Respecter l'ordre suivant pour les tests, car chaque ressource dépend de la précédente : **Authors → Categories → Books → Users → Loans**
